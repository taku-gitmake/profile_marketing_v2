      ...
      <header className="bg-white/80 backdrop-blur-sm border-b sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-slate-800">吉沢 拓哉</h1>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2 text-slate-700">
                    <p>
                      <span className="font-medium">名前：</span>吉沢 拓哉（すずき たくや）
                    </p>
                    <p>
      ...
      <footer className="bg-slate-800 text-white py-8 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center">
            <h3 className="text-xl font-bold mb-4">吉沢 拓哉</h3>
            ...
            <p className="text-slate-400 text-sm">© 2024 吉沢拓哉. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
